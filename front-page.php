...
<!-- Mirrored from bk-ninja.com/html_templates/unidark/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Dec 2022 09:44:09 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/xfavicon.png.pagespeed.ic.-yMpnxHG4r.png" sizes="32x32"/>
    <link rel="icon" href="img/xfavicon.png.pagespeed.ic.-yMpnxHG4r.png" sizes="192x192"/>
    <link rel="apple-touch-icon-precomposed" href="img/xfavicon.png.pagespeed.ic.-yMpnxHG4r.png"/>
    <meta name="msapplication-TileImage" content="img/favicon.png"/>
    <!-- Mobile Metas -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <!-- Mobile Metas -->
    <link rel="stylesheet" href="/wp-content/themes/arianblog/style.css">
    <!-- Theme CSS -->
    <style>@import url(css/vendors.css);@import url(css/atbs-style.css);@import url(css/module/header.css);@import url(css/module/footer.css);@import url(css/module/theme-setting.css);@import url(css/module/heading-title.css);@import url(css/module/atbs-featured-module-1.css);@import url(css/module/atbs-featured-module-2.css);@import url(css/module/atbs-featured-module-3.css);@import url(css/module/atbs-featured-module-4.css);@import url(css/module/atbs-posts-listing--list-1-has-sidebar.css);@import url(css/module/atbs-posts-listing--list-2-has-sidebar.css);@import url(css/module/atbs-posts-listing--grid-2-has-sidebar.css);@import url(css/module/atbs-posts-listing--grid-3-has-sidebar.css);@import url(css/module/atbs-posts-listing--grid-4-has-sidebar.css);@import url(css/module/atbs-posts-block-main-col-1.css);@import url(css/module/atbs-posts-block-main-col-2.css);@import url(css/module/atbs-posts-block-main-col-3.css);@import url(css/module/atbs-posts-block-main-col-4.css);@import url(css/module/widget.css);@import url(css/single.css);@import url(css/module/atbs-page-404.css);@import url(css/color.css);@import url(css/font.css);</style>
...
<div class="site-wrapper">
            ...
            <div class="mobile-header__inner mobile-header__inner--flex">
                <div class="header-branding header-branding--mobile mobile-header__section text-left">
                    <div class="header-logo header-logo--mobile flexbox__item text-left">
                        <a href="index-2.html">
                            <img src="img/xlogo.png.pagespeed.ic.ND3cL5TF02.png" alt="logo">
                        </a>
                    </div>
                </div>
            ...
            <div class="navigation-bar__inner flexbox-wrap flexbox-center-y">
                <div class="navigation-bar__section flex-box align-item-center">
                    <div class="header-logo">
                        <a href="index-2.html">
                            <img src="img/130xNxlogo.png.pagespeed.ic.8YxS2V6vb_.png" alt="File not found" width="130">
            ...
            <div class="atbs-block atbs-block--fullwidth atbs-section-module">
                            ...
                            <article class="post post--overlay post--overlay-middle post--overlay-large post--overlay-height-680 post--overlay-padding-lg">
                                <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                    <a href="single-1.html">
                                        <img src="img/x14.jpg.pagespeed.ic.dWzkcvkzNN.jpg" alt="file not found">
                                    </a>
                                </div>
                                    ...
                                    <div class="post__text-wrap">
                                        <div class="post__text-inner max-width-640">
                                            ...
                                            <h3 class="post__title f-40 f-w-700 m-b-15 max-width-640">
                                                <a href="single-1.html">I Was Trying To Daydream But My Mind Kept Wander.</a>
                                            </h3>
                                            <div class="post__meta">
                                                <div class="post-author post-author_style-7">
                                                    <a class="post-author__avatar" href="author.html" title="Posts by Connor Randall" rel="author">
                                                        <img alt="Connor Randall" src="img/x40.jpg.pagespeed.ic.fWq48IMSUo.jpg">
                                                    </a>
                                ...
                                <a href="single-1.html" class="link-overlay"></a>
                            </article>
                        </div>
                        <div class="section-sub">
                            <div class="owl-carousel js-atbs-carousel-4i30m atbs-carousel dots-circle dots-white" data-carousel-loop="true">
                                <div class="slide-content">
                                    <article class="post post--overlay post--overlay-cylinder post--overlay-cylinder-small post--overlay-bottom post--overlay-height-300">
                                        <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                            <a href="single-1.html">
                                                <img src="img/x26.jpg.pagespeed.ic.I_qjp0XMJf.jpg" alt="file not found">
                                            </a>
                                        </div>
                                        <div class="post__text inverse-text">
                                            <div class="post__text-wrap">
                                                <div class="post__text-inner">
                                                    <h3 class="post__title f-18 f-w-600 m-b-10">
                                                        <a href="single-1.html">Look Deep Into Nature, And  You Will Understand</a>
                                                    </h3>
                                                    <div class="post__meta">
                                                        <time class="time published" datetime="2019-03-06T08:45:23+00:00" title="March 6, 2019 at 8:45 am">March 6, 2019</time>
                                                    </div>
                                        ...
                                        <a href="single-1.html" class="link-overlay"></a>
                                        <a href="category.html" class="post__cat post__cat--bg overlay-item--top-left">GADGETS</a>
                                    </article>
                                </div>
                                <div class="slide-content">
                                    <article class="post post--overlay post--overlay-cylinder post--overlay-cylinder-small post--overlay-bottom post--overlay-height-300">
                                        <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                            <a href="single-1.html">
                                                <img src="img/x48.jpg.pagespeed.ic.GA-uaUqBL3.jpg" alt="file not found">
                                            </a>
                                        </div>
                                        <div class="post__text inverse-text">
                                            <div class="post__text-wrap">
                                ...
                                <div class="slide-content">
                                    <article class="post post--overlay post--overlay-cylinder post--overlay-cylinder-small post--overlay-bottom post--overlay-height-300">
                                        <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                            <a href="single-1.html">
                                                <img src="img/x30.jpg.pagespeed.ic.FBzXBR9DKQ.jpg" alt="file not found">
                                            </a>
                                        </div>
                                        <div class="post__text inverse-text">
                                            <div class="post__text-wrap">
                                ...
                                <div class="slide-content">
                                    <article class="post post--overlay post--overlay-cylinder post--overlay-cylinder-small post--overlay-bottom post--overlay-height-300">
                                        <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                            <a href="single-1.html">
                                                <img src="img/x42.jpg.pagespeed.ic.2mOB6FCIIb.jpg" alt="file not found">
                                            </a>
                                        </div>
                                        <div class="post__text inverse-text">
                                            <div class="post__text-wrap">
                                ...
                                <div class="slide-content">
                                    <article class="post post--overlay post--overlay-cylinder post--overlay-cylinder-small post--overlay-bottom post--overlay-height-300">
                                        <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                            <a href="#">
                                                <img src="img/x45.jpg.pagespeed.ic.E47hsl48XL.jpg" alt="file not found">
                                            </a>
                                        </div>
                                        <div class="post__text inverse-text">
                                            <div class="post__text-wrap">
                                                <div class="post__text-inner">
                                                    ...
                                                    <h3 class="post__title f-18 f-w-600 m-b-10">
                                                        <a href="#">Look Deep Into Nature, And  You Will Understand</a>
                                                    </h3>
                                                    <div class="post__meta">
                                                        <time class="time published" datetime="2019-03-06T08:45:23+00:00" title="March 6, 2019 at 8:45 am">March 6, 2019</time>
                                                    </div>
                        ...
                        <div class="posts-list flex-box flex-space-30 flex-box-4i posts-list-tablet-2i">
                            <div class="list-item">
                                <article class="post post--vertical post--vertical-style-card-thumb-aside atbs-post-hover-theme-style post--hover-theme">
                                    <div class="post__thumb object-fit">
                                        <a href="single-1.html">
                                            <img src="img/x11.jpg.pagespeed.ic.zeCuibrLS0.jpg" alt="File not found">
                                        </a>
                                    </div>
                                    <div class="post__text flex-box flex-direction-column inverse-text">
                                        <div class="post__text-group">
                                            ...
                                            <h3 class="post__title f-20 f-w-600 m-b-10 m-t-10 atbs-line-limit atbs-line-limit-3">
                                                <a href="single-1.html">Life Is Too Important To Be Taken Seriously</a>
                                            </h3>
                                            <div class="post-tags">
                                                <ul class="list-unstyled list-horizontal">
                                                    <li><a href="tags.html" class="post-tag" rel="tag">#motobike</a></li>
                                                    <li><a href="tags.html" class="post-tag" rel="tag">#booking</a></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="list-item">
                                <article class="post post--vertical post--vertical-style-card-thumb-aside atbs-post-hover-theme-style post--hover-theme">
                                    <div class="post__thumb object-fit">
                                        <a href="single-1.html">
                                            <img src="img/x1.jpg.pagespeed.ic.O6uac2ISN7.jpg" alt="File not found">
                                        </a>
                                    </div>
                                    <div class="post__text flex-box flex-direction-column inverse-text">
                                        <div class="post__text-group">
                            ...
                            <div class="list-item">
                                <article class="post post--vertical post--vertical-style-card-thumb-aside atbs-post-hover-theme-style post--hover-theme">
                                    <div class="post__thumb object-fit">
                                        <a href="single-1.html">
                                            <img src="img/x4.jpg.pagespeed.ic.2W-ikNOnIH.jpg" alt="File not found">
                                        </a>
                                    </div>
                                    <div class="post__text flex-box flex-direction-column inverse-text">
                                        <div class="post__text-group">
                            ...
                            <div class="list-item">
                                <article class="post post--vertical post--vertical-style-card-thumb-aside atbs-post-hover-theme-style post--hover-theme">
                                    <div class="post__thumb object-fit">
                                        <a href="single-1.html">
                                            <img src="img/x37.jpg.pagespeed.ic.ayVhDFUMOh.jpg" alt="File not found">
                                        </a>
                                    </div>
                                    <div class="post__text flex-box flex-direction-column inverse-text">
                                        <div class="post__text-group">
                ...
                <div class="flex-box">
                    <div class="atbs-main-col">
                                    ...
                                    <div class="owl-carousel js-atbs-carousel-1i atbs-carousel dots-circle nav-circle nav-horizontal nav-white">
                                        <div class="slide-content">
                                            <article class="post post--vertical post--vertical-card-overlap post--vertical-card-overlap-large">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html">
                                                        <img src="img/x8.jpg.pagespeed.ic.cYfNUCXF2p.jpg" alt="File not found">
                                                    </a>
                                                </div>
                                                <div class="post__text inverse-text">
                                        ...
                                        <div class="slide-content">
                                            <article class="post post--vertical post--vertical-card-overlap post--vertical-card-overlap-large">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html">
                                                        <img src="img/x9.jpg.pagespeed.ic._JCQ_3JaBB.jpg" alt="File not found">
                                                    </a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                        ...
                                        <div class="slide-content">
                                            <article class="post post--vertical post--vertical-card-overlap post--vertical-card-overlap-large">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html">
                                                        <img src="img/x10.jpg.pagespeed.ic.y6biDTpqzK.jpg" alt="File not found">
                                                    </a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                ...
                                <div class="section-sub">
                                    <div class="posts-list flex-box flex-box-1i">
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-middle post--horizontal-card-space flex-box post--hover-theme">
                                                <div class="post__thumb object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x49.jpg.pagespeed.ic.9Hze5bsQvO.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-middle post--horizontal-card-space flex-box post--hover-theme">
                                                <div class="post__thumb object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x10.jpg.pagespeed.ic.y6biDTpqzK.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                                    <h3 class="post__title f-17 f-w-500 m-t-10 m-b-10 atbs-line-limit atbs-line-limit-2">
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-middle post--horizontal-card-space flex-box post--hover-theme">
                                                <div class="post__thumb object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x17.jpg.pagespeed.ic.sDebjzjd0U.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                                    <h3 class="post__title f-17 f-w-500 m-t-10 m-b-10 atbs-line-limit atbs-line-limit-2">
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-middle post--horizontal-card-space flex-box post--hover-theme">
                                                <div class="post__thumb object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x18.jpg.pagespeed.ic.MCNnACnGyb.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text inverse-text">
                                                    <a href="category.html" class="post__cat">GADGETS</a>
                                                    <h3 class="post__title f-17 f-w-500 m-t-10 m-b-10 atbs-line-limit atbs-line-limit-2">
                        ...
                        <div class="atbs-block atbs-block--fullwidth atbs-posts-listing--grid-4-has-sidebar">
                            <div class="atbs-block__inner flex-box">
                                <div class="posts-list flex-box flex-box-3i flex-space-30 posts-list-tablet-2i">
                                    <div class="list-item">
                                        <article class="post post--vertical post--vertical-card-no-background">
                                            <div class="post__thumb object-fit b-r-8 post__thumb-radius">
                                                <a href="single-1.html">
                                                    <img src="img/x52.jpg.pagespeed.ic.tRfuU76-xB.jpg" alt="File not found">
                                                </a>
                                                <a href="category.html" class="post__cat post__cat--bg overlay-item--top-left">GADGETS</a>
                                            </div>
                                    ...
                                    <div class="list-item">
                                        <article class="post post--vertical post--vertical-card-no-background">
                                            <div class="post__thumb object-fit b-r-8 post__thumb-radius">
                                                <a href="single-1.html">
                                                    <img src="img/x3.jpg.pagespeed.ic.vvoRgtd-gr.jpg" alt="File not found">
                                                </a>
                                                <a href="category.html" class="post__cat post__cat--bg overlay-item--top-left">GADGETS</a>
                                            </div>
                                            <div class="post__text inverse-text author-avatar-right">
                                    ...
                                    <div class="list-item">
                                        <article class="post post--vertical post--vertical-card-no-background">
                                            <div class="post__thumb object-fit b-r-8 post__thumb-radius">
                                                <a href="single-1.html">
                                                    <img src="img/x50.jpg.pagespeed.ic.B6DaOWJ3us.jpg" alt="File not found">
                                                </a>
                                                <a href="category.html" class="post__cat post__cat--bg overlay-item--top-left">GADGETS</a>
                                            </div>
                                            <div class="post__text inverse-text author-avatar-right">
                        ...
                        <div class="atbs-block atbs-block--fullwidth atbs-posts-listing--grid-1-has-sidebar">
                            ...
                            <div class="atbs-block__inner">
                                <div class="posts-list flex-box flex-space-30 flex-box-3i posts-list-tablet-2i">
                                    <div class="list-item">
                                        <article class="post post--overlay post--overlay-normal post--overlay-cylinder-small post--overlay-bottom post--overlay-height-420 b-r-5">
                                            <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                                <a href="single-1.html">
                                                    <img src="img/x38.jpg.pagespeed.ic.8Z1YKTXJSv.jpg" alt="file not found">
                                                </a>
                                            </div>
                                            <div class="post__text inverse-text">
                                                <div class="post__text-wrap">
                                    ...
                                    <div class="list-item">
                                        <article class="post post--overlay post--overlay-normal post--overlay-cylinder-small post--overlay-bottom post--overlay-height-420 b-r-5">
                                            <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                                <a href="single-1.html">
                                                    <img src="img/x47.jpg.pagespeed.ic.1ubMR6qXQz.jpg" alt="file not found">
                                                </a>
                                            </div>
                                            <div class="post__text inverse-text">
                                                <div class="post__text-wrap">
                                    ...
                                    <div class="list-item">
                                        <article class="post post--overlay post--overlay-normal post--overlay-cylinder-small post--overlay-bottom post--overlay-height-420 b-r-5">
                                            <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                                <a href="single-1.html">
                                                    <img src="img/x33.jpg.pagespeed.ic.Kx_wr5V_KW.jpg" alt="file not found">
                                                </a>
                                            </div>
                                            <div class="post__text inverse-text">
                                                <div class="post__text-wrap">
                                    ...
                                    <div class="list-item">
                                        <article class="post post--overlay post--overlay-normal post--overlay-cylinder-small post--overlay-bottom post--overlay-height-420 b-r-5">
                                            <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                                <a href="single-1.html">
                                                    <img src="img/x23.jpg.pagespeed.ic.-ye9sWK85N.jpg" alt="file not found">
                                                </a>
                                            </div>
                                            <div class="post__text inverse-text">
                                                <div class="post__text-wrap">
                                    ...
                                    <div class="list-item">
                                        <article class="post post--overlay post--overlay-normal post--overlay-cylinder-small post--overlay-bottom post--overlay-height-420 b-r-5">
                                            <div class="post__thumb post__thumb--overlay atbs-thumb-object-fit">
                                                <a href="single-1.html">
                                                    <img src="img/x5.jpg.pagespeed.ic.rxVFasSg97.jpg" alt="file not found">
                                                </a>
                                            </div>
                                            <div class="post__text inverse-text">
                                                <div class="post__text-wrap">
                                ...
                                <div class="widget__inner">
                                    <div class="posts-list flex-box flex-space-30 flex-box-1i posts-list-tablet-2i">
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-reverse post--horizontal-xxs post--horizontal-middle">
                                                <div class="post__thumb atbs-thumb-object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x25.jpg.pagespeed.ic.T_TBYqt8Ml.jpg" alt="File not found"></a>
                                                </div>
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-reverse post--horizontal-xxs post--horizontal-middle">
                                                <div class="post__thumb atbs-thumb-object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x42.jpg.pagespeed.ic.2mOB6FCIIb.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text flex-box align-item-center">
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-reverse post--horizontal-xxs post--horizontal-middle">
                                                <div class="post__thumb atbs-thumb-object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x35.jpg.pagespeed.ic.tkLI4_sZFy.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text flex-box align-item-center">
                                        ...
                                        <div class="list-item">
                                            <article class="post post--horizontal post--horizontal-reverse post--horizontal-xxs post--horizontal-middle">
                                                <div class="post__thumb atbs-thumb-object-fit b-r-5 post__thumb-radius">
                                                    <a href="single-1.html"><img src="img/x2.jpg.pagespeed.ic.NeSc8iT8Qe.jpg" alt="File not found"></a>
                                                </div>
                                                <div class="post__text flex-box align-item-center">
                                    ...
                                    <div class="posts-list flex-box flex-space-30 flex-box-1i posts-list-tablet-2i">
                                        <div class="list-item">
                                            <article class="post post--vertical post--vertical-rectangle-outside">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html"><img src="img/x28.jpg.pagespeed.ic.QeDbvvsNuO.jpg" alt="File not found"></a>
                                                    <a href="category.html" class="post__cat post__cat--bg">GADGETS</a>
                                                </div>
                                        ...
                                        <div class="list-item">
                                            <article class="post post--vertical post--vertical-rectangle-outside">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html"><img src="img/x53.jpg.pagespeed.ic.RSCzVrBrGm.jpg" alt="File not found"></a>
                                                    <a href="category.html" class="post__cat post__cat--bg">GADGETS</a>
                                                </div>
                                                <div class="post__text">
                                                    <h3 class="post__title f-20 m-b-10 f-w-600">
                                        ...
                                        <div class="list-item">
                                            <article class="post post--vertical post--vertical-rectangle-outside">
                                                <div class="post__thumb object-fit">
                                                    <a href="single-1.html"><img src="img/x45.jpg.pagespeed.ic.E47hsl48XL.jpg" alt="File not found"></a>
                                                    <a href="category.html" class="post__cat post__cat--bg">GADGETS</a>
                                                </div>
                                                <div class="post__text">
                                                    <h3 class="post__title f-20 m-b-10 f-w-600">
                            ...
                            <div class="author-box author-box-vertical">
                                <div class="author-box__image">
                                    <div class="author-avatar">
                                        <img alt="designUTD" src="img/150x150x40.jpg.pagespeed.ic.ZMFV8ipM70.jpg" class="avatar avatar-150 photo avatar photo" height="150" width="150" loading="lazy">
                                    </div>
                                </div>
            ...
            <div class="site-footer__section-inner inverse-text">
                <div class="section-row">
                    <div class="section-column section-column-left text-left">
                        <div class="site-logo">
                            <a href="index-2.html">
                                <img src="img/108xNxlogo.png.pagespeed.ic.qLDLdWaLxn.png" alt="logo" width="108">
                            </a>
                        </div>
                    </div>
                    <div class="section-column section-column-center text-center">
                        <nav class="footer-menu text-center">
                            <ul id="menu-footer-menu" class="navigation navigation--footer navigation--inline">
                                <li class="current-menu-item"><a href="index-2.html">Homepage</a></li>
    ...
    <div id="atbs-offcanvas-primary" class="atbs-offcanvas js-atbs-offcanvas js-perfect-scrollbar">
        <div class="atbs-offcanvas__title">
            <h2 class="site-logo"><a href="index-2.html"><img src="img/xlogo.png.pagespeed.ic.ND3cL5TF02.png" alt="logo"></a></h2>
...
<script src="js/scripts.js.pagespeed.jm.Bj-_m2sOpH.js"></script>
</body>

<!-- Mirrored from bk-ninja.com/html_templates/unidark/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Dec 2022 09:45:05 GMT -->
</html>
